    ...
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
          პროექტის სტადიები, პროგრესი, ფაილები და შეტყობინებები.
        </p>
      </div>
          ...
          {projects.map((project) => (
            <li key={project.id}>
              <Link
                ...
                className="group block space-y-4 rounded-2xl border border-border/80 bg-card/90 p-4 shadow-[0_1px_2px_rgb(18_21_26/0.04)] transition-all hover:border-electric/25 hover:shadow-[0_8px_28px_rgb(18_21_26/0.06)] sm:p-5"
              >
                ...
                <ProjectStages status={project.status} compact />
              </Link>
            </li>
          ))}
        </ul>
